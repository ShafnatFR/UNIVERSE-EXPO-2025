                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-4 md:mb-6">
                            ...
                            <span className="text-pastel-mauve">Universe Expo?</span>
                        </h2>
                        <p className="text-base md:text-lg text-gray-300 mb-6 md:mb-8 leading-relaxed">
                            Bergabunglah dengan tim panitia Universe Expo 2025! Dapatkan pengalaman organisasi,
                            kembangkan skill, dan bangun koneksi yang berharga.
                        </p>

                        {/* OLD CONTENT - STUDENT PROBLEMS */}
                        ...
                        {/* NEW CONTENT - COMMITTEE BENEFITS */}
                        <div className="space-y-3 md:space-y-4">
                            {[
                                { icon: HelpCircle, text: "Kembangkan skill organisasi & leadership" },
                                { icon: Compass, text: "Networking dengan mahasiswa berbagai kampus" },
                                { icon: MapPin, text: "Pengalaman event organizing berskala besar" }
                            ].map((item, idx) => (
                                <div key={idx} className="flex items-center gap-3 md:gap-4 bg-white/5 p-3 md:p-4 rounded-2xl border border-white/10 backdrop-blur-sm">
                                    <div className="p-2 bg-pastel-mauve rounded-full text-slate-900 shrink-0">
                                        <item.icon size={18} className="md:w-5 md:h-5" />
                    ...
                    >
                        {/* Visual representation - Responsive Sizes */}
                        {/* OLD: <div className="absolute w-48 h-48 md:w-64 md:h-64 bg-black rounded-full shadow-[0_0_60px_rgba(168,85,247,0.4)] md:shadow-[0_0_100px_rgba(168,85,247,0.4)] z-10 flex items-center justify-center border border-purple-500/20">
                             <span className="text-4xl md:text-6xl animate-pulse">?</span> */}
                        {/* NEW: */}
                        <div className="absolute w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-pastel-pink/20 to-pastel-mauve/20 rounded-full shadow-[0_0_60px_rgba(244,194,194,0.4)] md:shadow-[0_0_100px_rgba(244,194,194,0.4)] z-10 flex items-center justify-center border border-pastel-pink/30">
                            <span className="text-4xl md:text-6xl animate-pulse">✨</span>
                        </div>
